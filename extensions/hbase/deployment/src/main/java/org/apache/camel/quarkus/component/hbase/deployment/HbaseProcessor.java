...
class HbaseProcessor {
    ...
    void runtimeInitializedClasses(BuildProducer<RuntimeInitializedClassBuildItem> runtimeInitializedClasses) {
        Stream.of("org.apache.hadoop.hbase.ipc.RemoteWithExtrasException$ClassLoaderHolder",
    ...
    @BuildStep
    void refelectiveClasses(BuildProducer<ReflectiveClassBuildItem> reflectiveClasses) {
