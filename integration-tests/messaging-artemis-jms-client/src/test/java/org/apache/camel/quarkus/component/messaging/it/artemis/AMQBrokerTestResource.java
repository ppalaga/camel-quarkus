 ...
 */
package org.apache.camel.quarkus.component.messaging.it.artemis;
...
public class AMQBrokerTestResource implements QuarkusTestResourceLifecycleManager {
    ...
    public Map<String, String> start() {
        ...
        try {
            ...
            String brokerUrlTcp = String.format("tcp://127.0.0.1:%d", container.getMappedPort(AMQ_PORT));
            String brokerUrlWs = String.format("ws://127.0.0.1:%d", container.getMappedPort(AMQ_PORT));

            return CollectionHelper.mapOf(
                    "quarkus.artemis.url", brokerUrlTcp,
                    "quarkus.artemis.username", AMQ_USER,
                    "quarkus.artemis.password", AMQ_PASSWORD,
                    "camel.component.paho.brokerUrl", brokerUrlTcp,
                    "camel.component.paho.username", AMQ_USER,
                    "camel.component.paho.password", AMQ_PASSWORD,
