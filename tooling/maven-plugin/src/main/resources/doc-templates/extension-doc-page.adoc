...
[#if !unlisted][.badges]
Create a new project [.badge-key]##link:https://code.quarkus.io/?extension-search=camel-quarkus-[=artifactIdBase][code.quarkus.io, window="_blank"]##[.badge-supported]##link:https://code.quarkus.io/?extension-search=camel-quarkus-[=artifactIdBase][camel-quarkus-[=artifactIdBase], window="_blank"]##

image:https://img.shields.io/badge/code.quarkus.io-camel%E2%80%92quarkus%E2%80%92[=artifactIdBase?replace("-", "%E2%80%92")]-blue.svg?logo=quarkus&logoColor=white&labelColor=3678db&color=e97826[link="https://code.quarkus.io/?extension-search=camel-quarkus-[=artifactIdBase]", window="_blank"]
